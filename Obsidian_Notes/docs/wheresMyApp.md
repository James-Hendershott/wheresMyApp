...
Add: README “Getting Started,” .env.example (DATABASE*URL, AUTH_SECRET, S3*\*), GitHub Actions workflow (lint, typecheck, test, build, e2e).
...
Branches:
main (deploy), develop (integration), short-lived feat/_, fix/_, chore/\*.
