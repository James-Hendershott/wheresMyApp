...
export function RegisterForm() {
  ...
  const button = "rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 w-full";

  return (
    <form ref={formRef} action={formAction} className="space-y-4 rounded border bg-white p-6 shadow">
      <div>
